			...
			if(container[i].tagName == 'INPUT' || container[i].tagName == 'SELECT') {
				...
				if (container[i].id == buttonStart){
					if(disableInputs == true){
						document.getElementById(buttonStart).className = "waves-effect waves-light btn tooltipped";
					}else{
						document.getElementById(buttonStart).className = "waves-effect waves-light btn tooltipped force-hide";
					}
				}else if (container[i].id == buttonEnd){
					if(disableInputs == true){
						document.getElementById(buttonEnd).className = "waves-effect waves-light btn tooltipped force-hide";
					}else{
						document.getElementById(buttonEnd).className = "waves-effect waves-light btn tooltipped";
					}
				}
			}else{
